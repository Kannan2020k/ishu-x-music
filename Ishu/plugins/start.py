...
from ishu import Telegram, YouTube, app
from ishu.misc import SUDOERS, _boot_
from ishu.plugins.playlist import del_plist_msg
from ishu.plugins.sudoers import sudoers_list
from ishu.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from ishu.utils.decorators.language import LanguageStart
from ishu.utils.formatters import get_readable_time
from ishu.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/poisonupdates) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/poisonupdates"
                        ),
                    ],
                ]
            )
