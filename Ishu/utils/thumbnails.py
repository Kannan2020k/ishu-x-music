...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"ishu/assets/anonx.png")
        ...
        font = ImageFont.truetype("ishu/assets/font2.ttf", 45)
        ImageFont.truetype("ishu/assets/font2.ttf", 70)
        arial = ImageFont.truetype("ishu/assets/font2.ttf", 30)
        ImageFont.truetype("ishu/assets/font.ttf", 30)
