...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", ": ˹ɪꜱʜᴜ ✘ ᴍᴜꜱɪᴄ˼ ~🎵")
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/poisonupdates")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/poisonteam1")
...
START_IMG_URL = getenv("START_IMG_URL", "https://graph.org/file/3493aa1f339e14460542f.jpg")
...
if PING_IMG_URL:
    if PING_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://telegra.ph/file/904b7ce31b8214cb44052.jpg"

if START_IMG_URL:
    if START_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://graph.org/file/3493aa1f339e14460542f.jpg"
